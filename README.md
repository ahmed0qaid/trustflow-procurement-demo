...
This is a companion upstream procurement application for [TrustFlow Sentinel](https://github.com/ahmed0qaid/trustflow-sentinel). It simulates an existing enterprise procurement system creating a payment-destination change request and sending it to TrustFlow.
